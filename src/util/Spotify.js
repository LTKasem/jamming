let accessToken;
let clientID = '9b710c0fd1a043139018b5dc8e1d1aec';
let RedirectUri = 'https://jamm1ng.netlify.app/'
const Spotify = {
    getAccessTocken() {
        if (accessToken) { return accessToken };
        //check accesTocken in (url)
        ...
        if (!accessToken) {
            let item = `https://accounts.spotify.com/authorize?client_id=${clientID}&response_type=token&scope=playlist-modify-public&redirect_uri=${RedirectUri}`
